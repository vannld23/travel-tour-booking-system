...
<aside class="h-full w-64 fixed left-0 top-0 bg-deep-navy shadow-lg flex flex-col py-6 z-50">
    ...
    <nav class="flex-1 space-y-1">
        <a class="flex items-center px-4 py-3 text-white/80 hover:bg-white/10 rounded-lg mx-2 my-1 transition-colors" href="<c:url value='/dashboard'/>">
        ...
        <a class="flex items-center px-4 py-3 bg-ocean-blue text-white rounded-lg mx-2 my-1 transition-all duration-200" href="<c:url value='/tour/list'/>">
            <span class="material-symbols-outlined mr-3">explore</span>
            <span class="font-label-md text-label-md">Quản lý Tour</span>
        </a>
        <a class="flex items-center px-4 py-3 text-white/80 hover:bg-white/10 rounded-lg mx-2 my-1 transition-colors" href="<c:url value='/booking/list'/>">
            <span class="material-symbols-outlined mr-3">confirmation_number</span>
            <span class="font-label-md text-label-md">Quản lý Đặt chỗ</span>
        </a>
        <a class="flex items-center px-4 py-3 text-white/80 hover:bg-white/10 rounded-lg mx-2 my-1 transition-colors" href="<c:url value='/report/revenue'/>">
            <span class="material-symbols-outlined mr-3">analytics</span>
            <span class="font-label-md text-label-md">Báo cáo</span>
        </a>
        <a class="flex items-center px-4 py-3 text-white/80 hover:bg-white/10 rounded-lg mx-2 my-1 transition-colors" href="<c:url value='/system/setting'/>">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <nav class="flex items-center gap-2 text-on-surface-variant font-label-sm text-label-sm mb-2">
                ...
                <span class="text-ocean-blue font-semibold">Thêm Tour Mới</span>
            </nav>
            <h2 class="font-headline-lg text-headline-lg text-deep-navy">Thêm Tour Mới</h2>
        </div>
    ...
    <div class="grid grid-cols-12 gap-gutter">
        <div class="col-span-8 space-y-gutter">
            <section class="glass-card rounded-xl p-6 shadow-[0px_4px_12px_rgba(0,0,0,0.05)]">
                ...
                <form:form id="tour-form" method="post" modelAttribute="tour" action="${pageContext.request.contextPath}/tour/create">
                    <div class="space-y-6">
                        <div>
                            <label class="block font-label-md text-label-md text-on-surface-variant mb-2">Tên Tour</label>
                            <form:input path="tourName" cssClass="w-full h-12 px-4 bg-surface-gray border-none rounded-lg text-body-md font-body-md" placeholder="vd: Khám phá dãy Alps hùng vĩ" />
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <form:input path="durationDays" cssClass="w-full h-12 px-4 bg-surface-gray border-none rounded-lg text-body-md font-body-md" placeholder="7" type="number" min="1" />
                        ...
                        <div>
                            ...
                            <form:textarea path="description" cssClass="w-full p-4 bg-surface-gray border-none rounded-lg text-body-md font-body-md resize-none" rows="6" placeholder="Mô tả hành trình, các điểm nổi bật và trải nghiệm độc đáo..." />
                        </div>
                    </div>
                </form:form>
            </section>
            ...
            <section class="glass-card rounded-xl p-6 shadow-[0px_4px_12px_rgba(0,0,0,0.05)]">
                ...
                <div class="grid grid-cols-3 gap-6">
                    <div>
                        ...
                        <form:input form="tour-form" path="price" cssClass="w-full h-12 px-4 bg-surface-gray border-none rounded-lg text-body-md font-body-md" placeholder="1200000" type="number" step="0.01" min="0" />
                    ...
                    <div>
                        ...
                        <form:input form="tour-form" path="maxCapacity" cssClass="w-full h-12 px-4 bg-surface-gray border-none rounded-lg text-body-md font-body-md" placeholder="20" type="number" min="1" />
        ...
        <div class="col-span-4 space-y-gutter">
            <section class="glass-card rounded-xl p-6 shadow-[0px_4px_12px_rgba(0,0,0,0.05)] h-full">
                ...
                <div>
                    ...
                    <form:input form="tour-form" path="imageUrl" cssClass="w-full h-12 px-4 bg-surface-gray border-none rounded-lg text-body-md font-body-md" placeholder="tour1.jpg" />
                </div>
            </section>
