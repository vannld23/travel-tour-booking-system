...
<aside class="h-full w-64 fixed left-0 top-0 bg-deep-navy shadow-lg flex flex-col py-6 z-50">
    <div class="px-6 mb-8">
        <h1 class="font-bold text-2xl text-white">VoyagerElite</h1>
        <p class="text-white/70 text-sm mt-1">Bảng quản trị Tour</p>
    </div>
...
<main class="flex-1 ml-64 p-8 min-h-screen">
    <div class="flex justify-between items-center mb-8">
        ...
        <a class="px-6 py-2.5 rounded-lg bg-ocean-blue text-white font-medium shadow-sm hover:brightness-110 transition-all" href="<c:url value='/tour/create'/>">Thêm Tour Mới</a>
    </div>
                        ...
                        <tr class="border-b border-outline-variant hover:bg-surface-bright">
                            ...
                            <td class="p-3">
                                <div class="flex flex-wrap gap-2">
                                    <a class="px-3 py-2 rounded-lg bg-surface-container text-on-surface-variant text-sm" href="<c:url value='/tour/detail'><c:param name='id' value='${tour.tourId}'/></c:url>">Chi tiết</a>
                                    <a class="px-3 py-2 rounded-lg bg-ocean-blue text-white text-sm" href="<c:url value='/tour/edit'><c:param name='id' value='${tour.tourId}'/></c:url>">Sửa</a>
                                    <a class="px-3 py-2 rounded-lg bg-action-orange text-white text-sm" href="<c:url value='/tour/delete'><c:param name='id' value='${tour.tourId}'/></c:url>">Xóa</a>
                                </div>
                            </td>
                        </tr>
                    </c:forEach>
