...
<%@ include file="layout/header.jsp" %>
    ...
    <section class="py-16 max-w-container-max mx-auto px-margin-desktop">
        <div class="flex justify-between items-end mb-10">
            <div>
                <h2 class="font-headline-lg text-headline-lg text-deep-navy font-bold">Tour nổi bật nhất</h2>
                <div class="h-1 w-20 bg-action-orange mt-2"></div>
            </div>
            <a class="text-ocean-blue font-label-md flex items-center hover:underline" href="#">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-gutter">
            <c:forEach var="tour" items="${tours}">
                ...
                <div class="tour-card bg-white rounded-xl overflow-hidden shadow-[0px_4px_12px_rgba(0,0,0,0.05)] border border-outline-variant/30 flex flex-col justify-between">
                    <div>
