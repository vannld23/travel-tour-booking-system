...
<head>
    ...
    <title>Quản trị VoyagerElite - Sửa Tour</title>
    <style>
...
<main class="flex-1 ml-[280px] p-8 min-h-screen">
    <div class="flex justify-between items-center mb-8">
        <div>
            <nav class="flex items-center gap-2 text-[#3f4752] text-sm mb-2">
                ...
                <span class="text-[#0194F3] font-semibold">Chỉnh sửa Tour</span>
            </nav>
            <h2 class="text-3xl font-bold text-[#05285D]">Chỉnh sửa Tour</h2>
        </div>
    ...
    <form:form id="tour-form" method="post" modelAttribute="tour" action="${pageContext.request.contextPath}/tuormanagement/edit" enctype="multipart/form-data">
                ...
                <section class="glass-card rounded-xl p-6 shadow-[0px_4px_12px_rgba(0,0,0,0.05)]">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <form:input path="tourName" cssClass="w-full h-12 px-4 bg-[#F2F3F3] border-none rounded-lg" />
        ...
        <footer class="mt-8 pt-8 border-t border-[#bfc7d4] flex justify-end gap-4">
            ...
            <button class="px-10 py-3 rounded-lg bg-[#FF5E1F] text-white shadow-lg" type="submit">Lưu thay đổi</button>
        </footer>
    </form:form>
</main>
</div>
